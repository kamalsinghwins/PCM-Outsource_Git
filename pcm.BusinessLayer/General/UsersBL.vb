...
Public Class UsersBL
    ...
    Public Function UpdateUserFile(ByVal Username As String, ByVal Password As String, ByVal isActive As String,
        ...
        Return _DLayer.UpdateUserFile(Username, Password, isActive, processing_sequence,
