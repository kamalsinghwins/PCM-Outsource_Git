...
Public Class StockcodesHOBL
    ...
    Public Function DeleteMasterCode(ByVal Stockcode As String) As String

        Return _DLayer.DeleteMasterCode(Stockcode)
    ...
    Public Function RunEmployeeReport(ByVal EMailAddresses As String,
        ...
        Return _DLayer.RunEmployeeReport(EMailAddresses, StartDate, EndDate, json)
