...
Public Class EmployeeBusinessLayer
    ...
    Public Function Save(test As Testing2) As BaseResponse
        _baseResponse = _dlEmployee.Testing(test)
        Return _baseResponse
    End Function
    Public Function getdata_testing() As DataTable
        Dim table As New DataTable
        table = _dlEmployee.getdata_testing()
        Return table
    End Function
    Public Function delete_testing(employee_number) As BaseResponse
        _baseResponse = _dlEmployee.delete_testing(employee_number)
        Return Nothing
    End Function
    Public Function update_testing(test As Testing2) As BaseResponse
        _baseResponse = _dlEmployee.update_testing(test)
        Return _baseResponse
    End Function
End Class
