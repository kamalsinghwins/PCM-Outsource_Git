...
Public Class DebtorsMaintainence
    ...
    Protected Sub ASPxCallback1_Callback(ByVal sender As Object, ByVal e As CallbackEventArgsBase)
        ...
        If hdWhichButton.Value = "CheckAccount" Then
            GetDebtor()
        End If
        ...
        If hdWhichButton.Value = "ClearForm" Then
            ClearForm()
        End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("maintenance_permission_sequence"), Screens.Maintenance.ManageDebtors) Then
                    If Not IsCallback Then
        ...
        '    _Log.WebPage = "Debtor Maintenance"
        ...
        Else
            ...
            chkDontSend.ReadOnly = True
            chkAgeAnalysis.ReadOnly = True
    ...
    Protected Sub cmdBtn_Click()
        ...
        Try
            ...
            Dim _Log As New PCMUserLog
            _Log.AccountNumber = ""
            _Log.ActionType = "Updating Debtor"
            _Log.IPAddress = Session("LoggingIPAddress")
            _Log.SearchCriteria = "Account Number: " & PersonalDetails.AccountNumber
            _Log.UserComment = ""
            _Log.UserName = Session("username")
            _Log.WebPage = "Debtor Maintenance"
    ...
    Protected Sub cmdReportingData_Click()
        ...
        Dim _Log As New PCMUserLog
        _Log.AccountNumber = ""
        _Log.ActionType = "Getting Reporting Data"
        _Log.IPAddress = Session("LoggingIPAddress")
        _Log.SearchCriteria = "Account Number: " & AccountNumber
        _Log.UserComment = ""
        _Log.UserName = Session("username")
        _Log.WebPage = "Debtor Maintenance"
    ...
    Private Sub ClearForm()
        ...
        Dim fileExists As Boolean = File.Exists(Session("XMLFileName"))

        If fileExists Then
            System.IO.File.Delete(Session("XMLFileName"))
        End If
        ...
        ASPxPageControl1.ActiveTabPage = ASPxPageControl1.TabPages.FindByName("Personal")
    ...
    Private Sub GetDebtor()
        ...
        If txtAccountNumber.Text = "" Then Exit Sub

        Dim strAccNum As String = txtAccountNumber.Text
        ...
        _Log.IPAddress = Session("LoggingIPAddress")
        _Log.SearchCriteria = "Account Number: " & strAccNum
        _Log.UserComment = ""
        _Log.UserName = Session("username")
        _Log.WebPage = "Debtor Maintenance"
        ...
        txtClockNumber.Text = _dt.Rows(_dt.Rows.Count - 1)("clock_number").ToString
        ...
        'Use guid to ensure no conflict on file with other users
        ...
        Session("XMLFileName") = Path.Combine(DirectoryPath, Guid.NewGuid.ToString & "-debtors_xml_data.xml")
        ...
        If XMLStream <> "" Then
            ...
            Using sw As New StreamWriter(File.Open(Session("XMLFileName"), FileMode.CreateNew))
            ...
            'Should be finished with the file
            If fileExists Then
                System.IO.File.Delete(Session("XMLFileName"))
            End If
    ...
    Private Function SetDebtorsEmploymentDetails() As DebtorsEmploymentDetails
        ...
        EmploymentDetails.tE_2 = ""
        EmploymentDetails.tE_3 = ""
        EmploymentDetails.tE_4 = ""
        EmploymentDetails.tE_5 = ""
        EmploymentDetails.tE_6 = ""
        EmploymentDetails.tE_7 = tE_7.Text.ToUpper
        EmploymentDetails.tE_8 = tE_8.Text

        EmploymentDetails.LOS = ""

        EmploymentDetails.chkRageEmployee = chkRageEmployee.Checked
        EmploymentDetails.ClockNumber = txtClockNumber.Text
    ...
    Protected Sub BureauEnquiries_DataBinding(ByVal sender As Object, ByVal e As EventArgs) Handles BureaEnquiresGridview.DataBinding
        ...
        If fileExists Then
            ...
            xmlDoc.Load(Session("XMLFileName"))
    ...
    Protected Sub grdDebtorsSearch_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim data As DataTable = _DebtorMaintainence.GetDebtors(_tmpCBO.Text, _tmpTXT.Text.ToUpper, _tmpCheck.Checked, _tmpLast100.Checked)
