<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="DebtorsMaintainence.aspx.vb" Inherits="pcm.Website.DebtorsMaintainence" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        //}
        ClearForm
        function ClearForm(s, e) {
            e.processOnServer = false;

            document.getElementById('<%=hdWhichButton.ClientID%>').value = "ClearForm";
        ...
        function CheckAccountNumberClick(s, e) {
            e.processOnServer = false;

            document.getElementById('<%=hdWhichButton.ClientID%>').value = "CheckAccount";
    ...
    <dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" runat="server" Width="100%" ClientInstanceName="cab"
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent3" runat="server">
                ...
                <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" ClientInstanceName="PageControl" CssClass="main_view">
                    <TabPages>
                                ...
                                <dx:ContentControl ID="ContentControl1" runat="server">
                                    <table id="tblContainer0">
                                        <tr>
                                            ...
                                            <td class="style3">
                                                <dx:ASPxButton ID="cmdCheck" runat="server" Text="Check">
                                                    <ClientSideEvents Click="CheckAccountNumberClick"></ClientSideEvents>
                                                </dx:ASPxButton>
                                            </td>
                                            <td>&nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td>
                                                <dx:ASPxCheckBox ID="chkAgeAnalysis" runat="server" CheckState="Unchecked" ReadOnly="True">
                                                </dx:ASPxCheckBox>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxComboBox ID="cboStatus" runat="server" EnableClientSideAPI="True">
                                                </dx:ASPxComboBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="auto-style2">
                                                <dx:ASPxCheckBox ID="chkDontSend" runat="server" CheckState="Unchecked" ReadOnly="true">
                                                </dx:ASPxCheckBox>
                                            ...
                                            <td>
                                                ...
                                                <dx:ASPxSpinEdit ID="txtCreditLimit" runat="server" Number="0" ReadOnly="true" MaxLength="10" MinValue="0" MaxValue="6000">
                                                </dx:ASPxSpinEdit>
                                                            ...
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>&nbsp;</td>
                                                                        <td>
                                                                            <dx:ASPxCheckBox ID="chkLast100" runat="server" CheckState="Unchecked">
                                                                            </dx:ASPxCheckBox>
                                                                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Last 100 Accounts">
                                                                            </dx:ASPxLabel>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                            ...
                            <ContentCollection>
                                <dx:ContentControl ID="ContentControl3" runat="server">
                                    <table id="tblContainer2">
                                        ...
                                        <tr>
                                            <td class="auto-style9">
                                                <dx:ASPxLabel ID="L_54" runat="server" Text="Employer Tel No">
                                                </dx:ASPxLabel>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style3"><dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Rage Employee">
                                                </dx:ASPxLabel></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td class="style3" colspan="2"><dx:ASPxCheckBox ID="chkRageEmployee" runat="server" CheckState="Unchecked">
                                                </dx:ASPxCheckBox></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td class="auto-style9">&nbsp;</td>
                                        ...
                                        <tr>
                                             <td class="auto-style3"><dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Clock Number">
                                                </dx:ASPxLabel></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td class="style3" colspan="2"><dx:ASPxTextBox ID="txtClockNumber" CssClass="UpperCase" runat="server" Width="170px">
                                                </dx:ASPxTextBox></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td class="auto-style9">&nbsp;</td>
                                                                    ...
                                                                    <td>
                                                                        <dx:ASPxGridView ID="grdClosingBalances" runat="server" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <dx:GridViewDataTextColumn Caption="Current Balance" FieldName="cbCurrent" VisibleIndex="2">
                                                                                </dx:GridViewDataTextColumn>
                                                                                <dx:GridViewDataTextColumn Caption="30 Days" FieldName="cb30Days" VisibleIndex="3"
                                                                                    Width="100px">
                                                                                </dx:GridViewDataTextColumn>
                                                                                <dx:GridViewDataTextColumn Caption="60 Days" FieldName="cb60Days" VisibleIndex="4"
                                                                                    Width="100px">
                                                                                </dx:GridViewDataTextColumn>
                                                                                <dx:GridViewDataTextColumn Caption="90 Days" FieldName="cb90Days" VisibleIndex="5"
                                                                                    Width="100px">
                                                                                </dx:GridViewDataTextColumn>
                                                                                <dx:GridViewDataTextColumn Caption="120 Days" FieldName="cb120Days" VisibleIndex="6"
                                                                                    Width="100px">
                                                                                </dx:GridViewDataTextColumn>
                                                                                <dx:GridViewDataTextColumn Caption="150 Days" FieldName="cb150Days" VisibleIndex="7"
                                                                                    Width="100px">
                                                                                </dx:GridViewDataTextColumn>
                                                                            </Columns>
                                                                        </dx:ASPxGridView>
...
<EditFormLayoutProperties ColCount="1"></EditFormLayoutProperties>
                ...
                <table class="notes_table">
                    ...
                    <tr>
                        <td class="style4"><dx:ASPxButton ID="cmdClear" runat="server" Text="Clear"
                                AutoPostBack="false" Style="height: 23px">
                                <ClientSideEvents Click="ClearForm"></ClientSideEvents>
                            </dx:ASPxButton>
                        </td>
                        <td>&nbsp;&nbsp;
                        </td>
