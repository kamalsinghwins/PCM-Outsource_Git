...
Public Class Intranet
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Mid$(Session("reporting_permission_sequence"), Screens.Reporting.Testing, 1) = "1" Then
            HeaderMenu.Items.FindByName("Testing").Enabled = True
        Else
            HeaderMenu.Items.FindByName("Testing").Enabled = False
        End If

        If Mid$(Session("reporting_permission_sequence"), Screens.Reporting.Testing1, 1) = "1" Then
            HeaderMenu.Items.FindByName("Testing1").Enabled = True
        Else
            HeaderMenu.Items.FindByName("Testing1").Enabled = False
        End If
