...
Partial Class collections_Default
            ...
            Else
                ...
                If chkRememberMe.Checked = True Then
                    If (Request.Browser.Cookies) Then
                        ...
                        If (Request.Cookies("PCMLOGIN") Is Nothing) Then
                            Response.Cookies("PCMLOGIN").Expires = DateTime.Now.AddDays(14)
                        End If

                        Response.Cookies("PCMLOGIN").Value = Encrypt(encrytUsernamePassword, _encryptionKey)
                    End If
                End If
