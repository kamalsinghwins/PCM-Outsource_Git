                    ...
                    <div class="left-side-tables" style="width: 100%; float: left;">
                        <fieldset>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan="4"> <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Note: Selecting no Transactions will run ALL Transactions"></dx:ASPxLabel></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td style="color: #666666; font-family: Tahoma; font-size: 14px;" colspan="5">
                            <dx:ASPxGridView ID="grdTransactions" runat="server" AutoGenerateColumns="False" OnDataBinding="grdTransactions_DataBinding"
                                ...
                                <GroupSummary>
                                    <dx:ASPxSummaryItem DisplayFormat="Transactions Total: {0}" FieldName="transaction_amount" SummaryType="Sum" />
                                </GroupSummary>
                                
                                <TotalSummary>
                                    <dx:ASPxSummaryItem FieldName="transaction_amount" SummaryType="Sum" />
                                </TotalSummary>
                            </dx:ASPxGridView>
                        </td>
