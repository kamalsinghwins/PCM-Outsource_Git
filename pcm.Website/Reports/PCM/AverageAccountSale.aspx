<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="AverageAccountSale.aspx.vb" Inherits="pcm.Website.AverageAccountSale" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetTransactions(s, e) {
            ...
            document.getElementById('<%=hdWhichButton.ClientID%>').value = "GetTransactions";
        ...
        function SendEndDate(s, e) {
            e.processOnServer = false;

            document.getElementById('<%=hdWhichButton.ClientID%>').value = "SendEndDate";
            ...
            <dx:PanelContent ID="PanelContent3" runat="server">
                ...
                <div class="mainContainer">
                    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="200px"
                        HeaderText="Average Account Sale" >
                        <PanelCollection>
                    ...
                    <dx:WebChartControl ID="transactionChart" runat="server" Height="510px" CrosshairEnabled="True" OnDataBinding="transactionChart_DataBinding" PaletteName="Flow" Width="414px">
                        ...
                        <Titles>
                            <cc1:ChartTitle Text="Total Account Count: 0"></cc1:ChartTitle>
                            <cc1:ChartTitle Text="Average Account Sales" Dock="Bottom"></cc1:ChartTitle>
                        </Titles>
                        <DiagramSerializable>
