<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="TransactionsByStore.aspx.vb" Inherits="pcm.Website.TransactionsByStore" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="200px"
        HeaderText="Transactions By Store" CssClass="date_panel">
        <PanelCollection>
   ...
   <dx:ASPxGridView ID="dxGrid" runat="server" CssClass="date_panel" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Time" FieldName="sale_time" 
                VisibleIndex="1">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Branch" FieldName="branch_code" VisibleIndex="2">
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn Caption="Trans. #" FieldName="reference_number" VisibleIndex="5">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Trans. Type" FieldName="transaction_type" 
                VisibleIndex="6">
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn Caption="Trans. Amount" FieldName="transaction_amount" 
                VisibleIndex="7">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Pay. Type" FieldName="pay_type" 
                VisibleIndex="8">
            </dx:GridViewDataTextColumn>
        ...
        <Settings ShowFilterRow="True" ShowGroupedColumns="True" 
            ShowGroupPanel="True" />
         <GroupSummary>
            <dx:ASPxSummaryItem DisplayFormat="# of Transactions: {0}" FieldName="reference_number" SummaryType="Count" 
                />
            <dx:ASPxSummaryItem DisplayFormat="Transactions Amount: {0}" FieldName="transaction_amount" SummaryType="Sum" />
