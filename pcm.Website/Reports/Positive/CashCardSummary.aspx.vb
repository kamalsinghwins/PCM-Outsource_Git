...
Public Class CashCardSummary
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            txtDateOpened.Text = Format(Now, "yyyy-MM-dd")
            txtLastTransaction.Text = Format(Now, "yyyy-MM-dd")
        End If
    ...
    Private Function GetData() As DataSet
        ...
        masterData = ReportData.ReturnCashCardSummary(txtDateOpened.Text, txtLastTransaction.Text)
        ...
        detailData = ReportData.ReturnCashCardSummaryLineItems(txtDateOpened.Text, txtLastTransaction.Text)
