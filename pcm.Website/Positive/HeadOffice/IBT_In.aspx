...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
        ...
        <div style="width: 80%; float: left;">
            ...
            <div onclick="updateQty()" class="dxbButton_Office2010Blue dxbButtonSys dxbTSys pull-right" style="-webkit-user-select: none;margin-top: 10px;">
                <div class="dxb">
        ...
        <div style="width: 20%; float: right; padding: 0 30px">
            ...
            <div>
                ...
                <span class="dxeBase_Office2010Blue">0. Itemcode<br/>
                    1. Description<br/>
                    2. SellEx<br/>
                    3. Tax<br/>
                    4. SellIncl<br/>
