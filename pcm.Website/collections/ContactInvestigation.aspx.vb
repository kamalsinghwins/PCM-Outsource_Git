...
Public Class ContactInvestigation1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("processing_permission_sequence"), Screens.Processing.ContactInvestigation) Then
                    If Not IsCallback Then
    ...
    Protected Sub ASPxNavBar2_ItemClick(source As Object, e As NavBarItemEventArgs) Handles ASPxNavBar2.ItemClick
        Dim _dlNextDebtor As New NextDebtorBusinessLayer
