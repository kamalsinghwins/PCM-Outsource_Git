...
Public Class hud
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("processing_permission_sequence"), Screens.Processing.Collection) Then
                    If Not IsCallback Then
        ...
        If Not IsPostBack Then
            ...
            If Session("collection_period") <> "" Then
                ...
                tmpDebtor = _dlNextDebtor.ReturnNextDebtor(Session("collection_period"), Session("username"))

                If Not IsNothing(tmpDebtor) Then
                    If tmpDebtor.AccountNumber = "" Then
                        'Period was finished
                        lblStatus.Text = "There are no accounts left for this period!"
    ...
    Private Sub ConvertTransactions()
        Dim _ListOfTransactions As New List(Of Transactions)

        Dim runningBalance As Double = 0
        For Each dr As DataRow In Session("_Transactions").Rows
        ...
        Session("_Transactions") = _ListOfTransactions
    ...
    Protected Sub ASPxCallback1_Callback(ByVal sender As Object, ByVal e As CallbackEventArgsBase)
        ...
        If hdWhichButton.Value = "BankingDetails" Then
            ...
            Dim message As String = "Rage Banking Details - Bank: Absa. Acc Name: Rage Distribution. Acc Num: 408 1269 231. " &
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles btnTest2.Click
        ...
        _dlNextDebtor.ReturnNextDebtor("60", Session("username"))
