...
Public Class ErrorLogDL
    ...
    Public Sub ErrorLogging(_error As Exception)
        ...
        Try
            ...
            tmpSQL = "insert into error_log(inner_exception,message,source,stack_trace,help_link,hresult,target_site,data)" & "VALUES('" & RG.Apos(_errorLog.InnerException) & "','" & RG.Apos(_errorLog.Message) & "','" & _errorLog.Source & "','" & _errorLog.StackTrace & "','" & _errorLog.HelpLink & "','" & _errorLog.HResult & "','" & _errorLog.TargetSite & "','" & _errorLog.Data & "')"
