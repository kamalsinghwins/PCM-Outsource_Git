...
Public Class UsersDL
    ...
    Public Function CheckUser(ByVal objUser As Users) As Users
        ...
        tmpSQL = "SELECT processing_sequence,maintenance_sequence,reporting_sequence,ustatus,pcm_admin " &
    ...
    Public Function ProcessLogin(ByRef objUser As Users) As Boolean
        ...
        tmpSQL = "INSERT INTO user_logins (date_time_of_login,user_name,permissions,ip_address,is_administrator) VALUES (" & _
                 "'" & Format(Now, "yyyy-MM-dd HH:mm") & "','" & RG.Apos(objUser.Username.ToUpper) & "'," & _
                 "'" & objUser.processing_permission_sequence & " " & objUser.maintenance_permission_sequence & " " & objUser.reporting_permission_sequence & "'," & _
    ...
    Public Function UpdateUserFile(ByVal Username As String, ByVal Password As String, ByVal isActive As String, ByVal processing_sequence As String,
        ...
        If isActive = True Then
            tmpSQL = "INSERT INTO wusers (username,userpass,ustatus,company,processing_sequence,maintenance_sequence,reporting_sequence,pcm_admin) " &
                      "VALUES ('" & RG.Apos(Username.ToUpper) & "','" & RG.Apos(Password.ToUpper) & "'," &
                     "'ACTIVE','','" & processing_sequence & "','" & maintenance_sequence & "','" & reporting_sequence & "','" & isPCMAdmin & "')"
        Else
            tmpSQL = "INSERT INTO wusers (username,userpass,ustatus,company,processing_sequence,maintenance_sequence,reporting_sequence,pcm_admin) VALUES " &
                     "('" & RG.Apos(Username.ToUpper) & "','" & RG.Apos(Password.ToUpper) & "'," &
                     "'INACTIVE','','" & processing_sequence & "','" & maintenance_sequence & "','" & reporting_sequence & "','" & isPCMAdmin & "')"
        End If
        Try
            objDBWrite.ExecuteQuery(tmpSQL)
        Catch ex As Exception
