...
ErrZ:
    ...
    Public Function OpenConnection(Optional ByVal BranchCode As String = "") As NpgsqlConnection
        ...
        Catch ex As Exception
            ...
            Msg3.Subject = "dlNpgSQL: Error Occurred in OpenConnection in PCM on " & hostName

            Msg3.Body = "Error: " & Err.Description & vbCrLf & localID & vbCrLf & "Connection String: " & _sqlConnection.ConnectionString & vbCrLf &
    ...
    Public Sub CloseConnection()
        ...
        Catch ex As Exception
            ...
            'Throw New System.Exception("An database exception has occurred.")

        End Try

    End Sub

    Public Function GetDataSet(ByVal strQuery As String, Optional ByVal BranchCode As String = "") As DataSet
        ...
        'Dim _NewLine As New WriteLogDL(HttpContext.Current.Server.MapPath("data\" & Format(Now, "yyyy-MM-dd") & ".XML"))
        '_NewLine.WriteLine(strQuery)
        '_NewLine.CloseStream()

        _dataset = New DataSet

        Try
            _sqlDataAdapter = New NpgsqlDataAdapter(strQuery, OpenConnection(BranchCode))
    ...
    Public Function ExecuteQuery(ByVal strQuery As String, Optional ByVal BranchCode As String = "") As String
