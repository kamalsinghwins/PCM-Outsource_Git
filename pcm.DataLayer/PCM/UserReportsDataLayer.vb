...
Public Class UserReportsDataLayer
    ...
    Public Function GetUserReportData(ByVal StartDate As String, ByVal EndDate As String) As List(Of UserReport)
        ...
        tmpSQL = "SELECT username,timestamp_of_action AS datetime,action_type AS action,account_number AS accountnumber,ptp_date AS ptpdate," &
                 "user_comment AS comment,action_result AS result,ptp_amount AS ptpamount,(length_of_action / 60) AS timespent,ip_address AS ipaddress, " &
                 "collections_period AS collectionsperiod,web_page,search_criteria " &
                 "FROM users_actions " &
