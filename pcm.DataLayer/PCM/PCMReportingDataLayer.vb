...
Public Class PCMReportingDataLayer
    ...
    Public Function GetEMailAddresses() As String
        ...
        tmpSQL = "SELECT email_address FROM debtor_personal WHERE email_address Like '%@%'"
        ...
        Try
            ...
            If objDB.isR(ds) Then
                For Each dr As DataRow In ds.Tables(0).Rows
                    ...
                    strStreamWriter.WriteLine(dr("email_address"))
                Next
            End If
        Catch ex As Exception
            If (objDB IsNot Nothing) Then
        ...
        tmpSQL = "SELECT email_address FROM customer_contact_details WHERE email_address like '%@%'"
        ...
        Try
            ...
            If objDB.isR(ds) Then
                For Each dr As DataRow In ds.Tables(0).Rows
                    ...
                    strStreamWriter.WriteLine(dr("cell_number"))
    ...
    Public Function GetReport(_reportRequest As ReportRequest) As ReportResponse
        ...
        Try
            ...
            tmpSQL = tmpSQL & "INNER JOIN debtor_dates ON dp.account_number = debtor_dates.account_number " &
                              "WHERE date_of_creation BETWEEN '" & _reportRequest.CboYear & "-" & tmpMonthInt & "-12' AND " &
