    ...
    Public Function FetchDetails(ByVal detailsRequest As FetchDetails) As FetchDetailsResponse
        ...
        Try
            ...
            tmpSQL = "SELECT " &
                     ...
                     "WHERE ibt_transactions.sending_branch_code = '" & Current_Branch_Code.ToUpper & "' " &
                     "AND ibt_transactions.transaction_number = '" & RG.Apos(detailsRequest.IBTOutNumber.ToUpper) & "' " &
                     "AND ibt_transactions.receiving_branch_code =  '" & RG.Apos(detailsRequest.FromBranch.ToUpper) & "' " &
                     "AND ibt_transactions.received_qty = 0"
            ...
            If usingObjDB.isR(Ds) Then
                ...
                For Each dr As DataRow In Ds.Tables(0).Rows
                    If dr("sending_branch_code") <> "" Then
                        ...
                        listData.CostPrice = (RG.Numb(dr("cost_price"))) '20
