...
Public Class IBT_OutHODL
    ...
    Public Function GetGeneratedCodeInfo(ByVal strGeneratedCodeOrBarcode As String, ByVal _strBranchCode As String) As GetGeneratedCodeInfoResponse
        ...
        Try
            ...
            If usingObjDB.isR(Ds) Then
                ...
                generatedCodeInfoResponse.CodeMinimumStockLevelDBL = Ds.Tables(0).Rows(0)("minimum_stock_level") & ""

                generatedCodeInfoResponse.CodeCostAverageExclusiveDBL = Ds.Tables(0).Rows(0)("cost_price") & ""
                generatedCodeInfoResponse.CodeEstimatedCostExclusiveDBL = Ds.Tables(0).Rows(0)("estimated_cost") & ""
                generatedCodeInfoResponse.CodeSellingExlusive1DBL = Ds.Tables(0).Rows(0)("selling_price_1") & ""
                generatedCodeInfoResponse.CodeSellingExlusive2DBL = Ds.Tables(0).Rows(0)("selling_price_2") & ""
                generatedCodeInfoResponse.CodeSellingExlusive3DBL = Ds.Tables(0).Rows(0)("selling_price_3") & ""
                ...
                generatedCodeInfoResponse.CodeQuantityOnHand = Ds.Tables(0).Rows(0)("qty_on_hand").ToString.ToUpper & ""
            Else
                'Check for barcode
    ...
    Public Function Searchicibtout(ByVal SearchText As String, ByVal SearchType As String, ByVal Master As Boolean) As SearchResponse
        ...
        Else
            ...
            If SearchType = "Generated Code" Then
                tmpSQL = "SELECT generated_code as code,description,sku_number FROM stockcodes_master WHERE generated_code ILIKE '" & RG.Apos(SearchText.ToString.ToUpper) & "%' ORDER BY generated_code ASC LIMIT 50 "
            ElseIf SearchType = "Barcode" Then
                tmpSQL = "SELECT generated_code as code,description,sku_number FROM stockcodes_master WHERE sku_number ILIKE '" & RG.Apos(SearchText.ToString.ToUpper) & "%' ORDER BY sku_number ASC LIMIT 50 "
            ElseIf SearchType = "Description" Then
                tmpSQL = "SELECT generated_code as code,description,sku_number FROM stockcodes_master WHERE description ILIKE '" & RG.Apos(SearchText.ToString.ToUpper) & "%' ORDER BY description ASC LIMIT 50 "
            End If
        End If
