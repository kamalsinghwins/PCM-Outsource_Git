...
Public Class StockcodesHODL
    ...
    Public Function RunStockAllocation(ByVal Filename As String, ByVal EMailAddresses As String) As String
        ...
        tmpSQL = "INSERT INTO tasks (task_type,file_to_run,timestamp_created,email_addresses) VALUES " & _
    ...
    Public Function InsertPrePack(ByVal PrePack As PrePack) As String
        ...
        tmpSQL = "SELECT size_grid FROM stock_pre_packs WHERE pre_pack_code = '" & RG.Apos(PrePack.PrePackCode.ToUpper) & "' " & _
        ...
        For i As Integer = 0 To PrePack.PrePackGrid.Count - 1
            tmpSQL = "INSERT INTO stock_pre_packs (pre_pack_code,size_grid,size,pre_pack_quantity) VALUES " & _
                    "('" & RG.Apos(Mid$(PrePack.PrePackCode.ToUpper, 1, 15)) & "','" & RG.Apos(Mid$(PrePack.SizeGrid.ToUpper, 1, 4)) & "'," & _
    ...
    Public Function InsertStockcode(ByVal _Stockcode As Stockcode) As String
        ...
        'Insert prices
        tmpSQL = "INSERT INTO stockcodes_prices (master_code,generated_code,estimated_cost,selling_price_1,selling_price_2,selling_price_3) " & _
                 "VALUES('" & RG.Apos(Mid$(_Stockcode.MasterCode.ToUpper, 1, 20)) & "','" & RG.Apos(Mid$(_Stockcode.GeneratedCode.ToUpper, 1, 30)) & "'," & _
                 "'" & RG.Numb(_Stockcode.CostExclusive, 3) & "','" & RG.Numb(_Stockcode.SellingPrice1, 3) & "'," & _
        ...
        tmpSQL = "INSERT INTO stockcodes_price_updates (guid,date_of_change,time_of_change,master_code," & _
                 "generated_code,new_price_1,new_price_2,new_price_3,user_name) " & _
                 " VALUES ('" & tmpGUID & "','" & Format(Now, "yyyy-MM-dd") & "','" & Format(Now, "HH:mm:ss") & "'," & _
                 "'" & RG.Apos(Mid$(_Stockcode.MasterCode.ToUpper, 1, 20)) & "','" & RG.Apos(Mid$(_Stockcode.GeneratedCode.ToUpper, 1, 30)) & "'," & _
                 "'" & RG.Numb(_Stockcode.SellingPrice1, 3) & "'," & _
        ...
        tmpSQL = "INSERT INTO stockcodes_dates (master_code,generated_code,created) VALUES('" & RG.Apos(Mid$(_Stockcode.MasterCode.ToUpper, 1, 20)) & "'," & _
        ...
        tmpSQL = "INSERT INTO stock_bestsellers_monthly (master_code,generated_code) VALUES ('" & RG.Apos(Mid$(_Stockcode.MasterCode.ToUpper, 1, 20)) & "'," & _
        ...
        tmpSQL = "INSERT INTO stock_bestsellers_weekly (master_code,generated_code) VALUES ('" & RG.Apos(Mid$(_Stockcode.MasterCode.ToUpper, 1, 20)) & "'," & _
                 "'" & RG.Apos(Mid$(_Stockcode.GeneratedCode.ToUpper, 1, 30)) & "')"
        Try
            objDBWrite.ExecuteQuery(tmpSQL)
        Catch ex As Exception
    ...
    Public Function UpdateStockcode(ByVal _Stockcode As Stockcode) As String
                ...
                If objDBRead.isR(ds) Then
                    For Each dr As DataRow In ds.Tables(0).Rows
                        If dr("master_code") <> "" Then
                            ...
                            tmpSQL = "INSERT INTO stockcodes_price_updates (guid,date_of_change,time_of_change,master_code," & _
                                     "generated_code,new_price_1,new_price_2,new_price_3,user_name) " & _
                                     " VALUES ('" & Guid.NewGuid.ToString & "','" & Format(Now, "yyyy-MM-dd") & "','" & Format(Now, "HH:mm:ss") & "'," & _
                                     "'" & dr("master_code") & "','" & dr("generated_code") & "'," & _
                                     "'" & RG.Numb(_Stockcode.SellingPrice1, 3) & "','" & RG.Numb(_Stockcode.SellingPrice2, 3) & "'," & _
                    ...
                    For Each dr As DataRow In ds.Tables(0).Rows
                        If dr("master_code") <> "" Then
                            tmpSQL = "INSERT INTO stockcodes_price_updates (guid,date_of_change,time_of_change,master_code," & _
                                     "generated_code,new_price_1,new_price_2,new_price_3,user_name) " & _
                                     " VALUES ('" & Guid.NewGuid.ToString & "','" & Format(Now, "yyyy-MM-dd") & "','" & Format(Now, "HH:mm:ss") & "'," & _
                                     "'" & dr("master_code") & "','" & RG.Apos(_Stockcode.GeneratedCode.ToUpper) & "'," & _
                                     "'" & RG.Numb(_Stockcode.SellingPrice1, 3) & "','" & RG.Numb(_Stockcode.SellingPrice2, 3) & "'," & _
                                     "'" & RG.Numb(_Stockcode.SellingPrice3, 3) & "','WEB')"
        ...
        If CodeCount > 1 Then 'Don't update description when there are generated codes - 2013-10-30: and barcode - and never update the generated codes!
            tmpSQL = "UPDATE stockcodes_master SET " & _
               "is_service_item='" & _Stockcode.isServiceItem & "'," & _
               "purchase_tax_group='" & _Stockcode.PurchaseTaxGroup & "'," & _
               "sales_tax_group='" & _Stockcode.SalesTaxGroup & "',supplier ='" & RG.Apos(_Stockcode.Supplier.ToUpper) & "'," & _
               "suppliers_code='" & RG.Apos(_Stockcode.SupplierCode.ToUpper) & "',is_not_discountable='" & _Stockcode.isNotDiscountable & "'," & _
               "is_blocked='" & _Stockcode.isBlocked & "',minimum_stock_level='" & Val(_Stockcode.MinumumLevel) & "'," & _
               "colour_matrix='" & RG.Apos(_Stockcode.ColourString.ToUpper) & "'"
        Else
            tmpSQL = "UPDATE stockcodes_master SET " & _
               "sku_number='" & RG.Apos(_Stockcode.Barcode.ToUpper) & "',is_service_item='" & RG.Apos(_Stockcode.isServiceItem) & "'," & _
               "purchase_tax_group='" & _Stockcode.PurchaseTaxGroup & "',description='" & Mid$(RG.Apos(_Stockcode.Description.ToUpper), 1, 50) & "'," & _
               "sales_tax_group='" & _Stockcode.SalesTaxGroup & "',supplier ='" & RG.Apos(_Stockcode.Supplier.ToUpper) & "'," & _
               "suppliers_code='" & RG.Apos(_Stockcode.SupplierCode.ToUpper) & "',is_not_discountable='" & _Stockcode.isNotDiscountable & "'," & _
               "is_blocked='" & _Stockcode.isBlocked & "',minimum_stock_level='" & Val(_Stockcode.MinumumLevel) & "'," & _
               "colour_matrix='" & RG.Apos(_Stockcode.ColourString.ToUpper) & "'"
        ...
        'Update categories
        tmpSQL = "UPDATE stockcodes_categories SET " & _
                 "category_1='" & RG.Apos(_Stockcode.Category1.ToUpper) & "',category_2='" & RG.Apos(_Stockcode.Category2.ToUpper) & "', " & _
        ...
        'Update prices
        tmpSQL = "UPDATE stockcodes_prices SET " & _
                 "estimated_cost='" & RG.Numb(_Stockcode.CostExclusive, 3) & "'," & _
                 "selling_price_1='" & RG.Numb(_Stockcode.SellingPrice1, 3) & "',selling_price_2='" & RG.Numb(_Stockcode.SellingPrice2, 3) & "'," & _
    ...
    Public Function GetSupplierList(ByVal SearchString As String) As DataTable
        ...
        Try
            ...
            tmpSQL = "SELECT supplier_code,supplier_name " & _
                     "FROM supplier_details " & _
    ...
    Public Function DeleteMasterCode(ByVal _Stockcode As String) As String
    ...
    Public Function GetMasterCodeInfo(ByVal Stockcode As String) As DataTable
        ...
        Try
            ...
            tmpSQL = "Select " & _
                     "stockcodes_master.master_code,stockcodes_master.generated_code,stockcodes_master.sku_number,stockcodes_master.is_service_item," & _
                     "stockcodes_master.description,stockcodes_master.purchase_tax_group,stockcodes_master.sales_tax_group,stockcodes_master.supplier," & _
                     "stockcodes_master.suppliers_code,stockcodes_master.is_not_discountable,stockcodes_master.is_blocked," & _
                     "stockcodes_master.minimum_stock_level,stockcodes_master.item_size,stockcodes_master.item_colour,stockcodes_master.size_matrix," & _
                     "stockcodes_master.colour_matrix,stockcodes_categories.category_1,stockcodes_categories.category_2,stockcodes_categories.category_3," & _
                     "stockcodes_prices.selling_price_3,stockcodes_prices.selling_price_2,stockcodes_prices.selling_price_1," & _
                     "stockcodes_prices.estimated_cost,stockcodes_prices.cost_price " & _
                     "FROM " & _
                     "stockcodes_master " & _
                     "LEFT OUTER JOIN stockcodes_prices On stockcodes_master.generated_code = stockcodes_prices.generated_code " & _
                     "LEFT OUTER JOIN stockcodes_categories On stockcodes_master.generated_code = stockcodes_categories.generated_code " & _
    ...
    Public Function RunEmployeeReport(ByVal EMailAddresses As String,
                                    ByVal StartDate As String, ByVal EndDate As String, ByVal json As String) As String
