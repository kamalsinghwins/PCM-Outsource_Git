        ...
        Try
            ...
            Else
                strQuery = "SELECT " & _
                           ...
                           "branch_code,account_number,transaction_type,transaction_number,transaction_total,transaction_points " & _
                           "FROM transaction_customer " & _
                           "WHERE account_number = '" & RG.Apos(AccountNumber) & "' ORDER BY sale_date ASC"
            End If
    ...
    Public Function ReturnCashCardSummary(ByVal DateCreated As String, ByVal LastTransactionDate As String) As DataTable
        ...
        Try
            ...
            strQuery = "SELECT " &
                       ...
                       "WHERE " &
                       "customer_dates.date_account_opened >= '" & DateCreated & "' AND customer_dates.date_last_transaction >= '" & LastTransactionDate & "' " &
