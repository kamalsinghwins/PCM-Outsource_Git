...
Public Class CashCardDataLayer
    ...
    Private Sub InsertIntoCustomerLog(ByVal Database As String, ByVal BranchCode As String, ByVal Username As String,
        ...
        tmpSQL = "INSERT INTO customer_change_log (guid,account_number,timestamp_of_change,username,branch_code,field_name,old_value,new_value) VALUES " & _
                 "('" & Guid.NewGuid.ToString & "','" & AccountNumber & "',localtimestamp,'" & Username & "','" & BranchCode & "','" & RG.Apos(FieldName) & "'," & _
    ...
    Public Function GetCustomerList(ByVal AccountDetails As CashCardCustomer,
        ...
        If isSearchByID = True Then
            tmpSQL = "SELECT p.account_number,account_name,first_name,last_name,contact_number " & _
                     "FROM customer_personal p " & _
                     "LEFT OUTER JOIN customer_contact_details d ON p.account_number = d.account_number " & _
    ...
    Public Function UpdateCustomerTable(ByVal AccountDetails As CashCardCustomer) As String
        ...
        'Get details
        tmpSQL = "SELECT cp.first_name,cp.last_name,cp.customer_status,cp.is_female,cp.send_promos, " & _
                 "ccd.email_address,ccd.contact_number,ccd.state " & _
                 "FROM " & _
                 "customer_personal cp " & _
                 "LEFT OUTER JOIN customer_contact_details ccd ON cp.account_number = ccd.account_number " & _
    ...
    Public Function ProcessGiftCardSale(ByVal CashCardTransactionData As CashCardEntity) As String
        ...
        tmpSQL = "SELECT " & _
                 "card_details.card_number," & _
                 "card_details.current_status AS card_status,balance " & _
                 "FROM " & _
                 "card_details " & _
                 "INNER JOIN card_gift_cards gc ON gc.card_number = card_details.card_number " & _
        ...
        tmpSQL = "UPDATE card_gift_cards SET balance = balance - " & val(CashCardTransactionData.TransactionTotal) & "," & _
        ...
        tmpSQL = "INSERT INTO financial_transactions (sale_date,sale_time,current_period,username,account_number,reference_number," & _
                 "transaction_type,transaction_amount,pay_type) VALUES " & _
                 "('" & Format(Now, "yyyy-MM-dd") & "','" & Format(Now, "HH:mm:ss") & "','" & CurrentPeriod & "'," & _
                 "'WEB SERVICE','" & CashCardTransactionData.GiftCardNumber & "','" & CashCardTransactionData.BranchCode & CashCardTransactionData.TransactionNumber & "'," & _
    ...
    Public Function RedeemPoints(ByVal CashCardTransactionData As CashCardEntity) As String
        ...
        tmpSQL = "SELECT customer_personal.account_number,customer_balances.current_points_balance,cash_card_details.is_active " & _
                 "FROM cash_card_details " & _
                 "INNER JOIN customer_personal ON cash_card_details.account_number = customer_personal.account_number " & _
                 "INNER JOIN customer_balances ON cash_card_details.account_number = customer_balances.account_number " & _
        ...
        tmpSQL = "SELECT " & _
                 "card_details.card_number," & _
                 "card_details.current_status AS card_status " & _
                 "FROM " & _
                 "card_details " & _
                 "WHERE card_details.card_number = '" & CashCardTransactionData.GiftCardNumber & "'"
        Try
        ...
        tmpSQL = "UPDATE customer_balances SET current_points_balance = current_points_balance - " & Val(CashCardTransactionData.PointsToRedeem) & " " & _
        ...
        tmpSQL = "INSERT INTO financial_transactions (sale_date,sale_time,current_period,username,account_number,reference_number," & _
                 "transaction_type,transaction_amount,pay_type) VALUES " & _
                 "('" & Format(Now, "yyyy-MM-dd") & "','" & Format(Now, "HH:mm:ss") & "','" & CurrentPeriod & "'," & _
                 "'POINTS REDEMPTION','" & CashCardTransactionData.GiftCardNumber & "','" & CashCardTransactionData.BranchCode & TransactionNumber & CashCardTransactionData.TransactionNumber & "'," & _
        ...
        tmpSQL = "INSERT INTO transaction_customer " & _
                 "(guid,sale_date,sale_time,branch_code,account_number,transaction_type,transaction_number,transaction_total," & _
                 "transaction_points)" & _
                 " VALUES('" & RG.Apos(Guid.NewGuid.ToString) & "','" & CashCardTransactionData.TransactionDate & "','" & CashCardTransactionData.TransactionTime & "','" & Mid$(RG.Apos(CashCardTransactionData.BranchCode), 1, 5) & "'," & _
                 "'" & Mid$(RG.Apos(AccountNumber), 1, 30) & "','" & CashCardTransactionData.TransactionType & "'," & _
                 "'" & CashCardTransactionData.BranchCode & TransactionNumber & CashCardTransactionData.TransactionNumber & "'," & _
                 "'" & Val(CashCardTransactionData.TransactionTotal) & "'," & _
    ...
    Public Function ReturnPointsBalance(ByVal CardNumber As CashCardCustomer) As CashCardCustomer
        ...
        'Get details
        tmpSQL = "SELECT customer_personal.first_name,customer_personal.last_name,customer_balances.current_points_balance,cash_card_details.is_active " & _
                 "FROM cash_card_details " & _
                 "INNER JOIN customer_personal ON cash_card_details.account_number = customer_personal.account_number " & _
                 "INNER JOIN customer_balances ON cash_card_details.account_number = customer_balances.account_number " & _
